...
redipsInit = function () {
    ...
    rd.event.changed = function () {
        ...
        msg.innerHTML = 'Changed: ' + pos[1] + ' ' + (pos[2]) +rd.obj.id ;
//        var ajax_load = "<div style='margin:35px auto;text-align:center'><img src={{ asset('bundles/scrumassets/img/load.gif') }} alt='loading...' /> </div>";
        var loadUrl = $("#loadlink").attr('href')+ "/"+(pos[2]+1)+"/" +rd.obj.id;
        $("#resultContainer").load(loadUrl);
